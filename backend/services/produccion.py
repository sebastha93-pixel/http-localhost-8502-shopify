...
def generar_zpl_trabajo(t: dict) -> str:
    ...
    if t.get("tipo") == "instruccion_lavado":
        # La etiqueta de lavado se compone como IMAGEN (fuentes de marca +
        # logo + símbolos oficiales) y se manda como BITMAP TSPL con corte.
        # Ver generar_contenido_trabajo() — devuelve bytes, no texto.
        return ""
    return ""
