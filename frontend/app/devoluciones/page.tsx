...
export default function DevolucionesPage() {
  ...
  return (
    ...
    >
      <KpiStrip
        items={[
          { label: "Total",     value: groups.todas.length },
          { label: "Activas",   value: groups.activas.length, tone: groups.activas.length > 0 ? "danger" : "default" },
          { label: "En ruta",   value: groups.enRuta.length },
          { label: "Resueltas", value: groups.resueltas.length, tone: "success" },
        ]}
      />
        ...
        <Tabs defaultValue="activas">
          ...
          <TabsContent value="activas">
            <PedidosTable
              ...
              emptyMessage="Sin devoluciones activas. Equipo al día."
          ...
          <TabsContent value="resueltas">
            <PedidosTable
              ...
              emptyMessage="Sin devoluciones resueltas en este período."
